...
export const userPageSettingSchemas = {
  ...
  "auth.loginDisabledMessage": z.string().trim().min(1).max(120),
  "auth.registrationDisabledMessage": z.string().trim().min(1).max(120),
  "auth.inviteRequiredMessage": z.string().trim().min(1).max(120),
